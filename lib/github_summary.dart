        ...
        return ListView.builder(
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              onTap: () => _launchUrl(context, Uri.parse(repository.htmlUrl)),
            );
          },
        ...
        return ListView.builder(
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              onTap: () =>
                  _launchUrl(context, Uri.parse(assignedIssue.htmlUrl)),
            );
          },
        ...
        return ListView.builder(
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              onTap: () =>
                  _launchUrl(context, Uri.parse(pullRequest.htmlUrl ?? '')),
            );
          },
